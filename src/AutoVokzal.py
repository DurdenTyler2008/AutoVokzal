...
class Kassa:
    def __init__(self, tickets, passenger, sales):
        self.tickets = tickets
        self.passenger = passenger
        self.sales = sales

    def sale(self, passenger = bool, tickets = int, sales = bool):
        assert self.passenger == passenger #проверяю наличие пассажира.bool
        assert self.tickets >= tickets #проверяю наличие билетов.int
        assert self.sales == sales #проверяю факт продажи.bool
